# ====================================================================================
# Setup Project
PROJECT_NAME := provider-cloudamqp
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Cloudamqp CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Cloudamqp controllers
...
# This target prepares repo for your provider by replacing all "cloudamqp"
