...
The [provider-cloudamqp](https://github.com/crossplane/provider-cloudamqp) repository can be
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-cloudamqp/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-cloudamqp/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-cloudamqp/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-cloudamqp/blob/main/hack/boilerplate.go.txt)
...
The [provider-cloudamqp](https://github.com/crossplane/provider-cloudamqp)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-cloudamqp/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-cloudamqp/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue cloudamqps (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-cloudamqp/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Cloudamqps: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-cloudamqp/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
